import { ChevronRight, ChevronsLeft, ChevronsRight, MoreHorizontal, Search } from "lucide-react";
							...
							<td
								...
								<div className="inline-flex items-center gap-8">
									...
									<div className="flex gap-1.5">
										<button className="bg-white/10 border border-white/10 rounded-md p-1.5 opacity-50">
